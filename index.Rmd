...
dataset <- read.csv("/data/world-happiness/2017.csv",stringAsFactor = FALSE)
summary_list <- get_summary_info(dataset)
```
## Summary Information

The World Happiness Index surveyed `r summary_list$num_row` countries. The happiest country in the world in 2017 was `r happiest_country` with a score of `r highest_happiness_score`. The unhappiest country in the world was `r unhappiest_country` with a score of `r lowest_happiness_score` 
